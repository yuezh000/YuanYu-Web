      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="card-glow rounded-2xl p-5 sm:p-8 transition-all duration-300">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">数据安全与隐私</h3>
          ...
          <div className="card-glow rounded-2xl p-5 sm:p-8 transition-all duration-300">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">客户成功体系</h3>
            <ul className="space-y-3 text-gray-600 dark:text-gray-400 text-sm">
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-primary mt-1.5 shrink-0" />
                专属客服团队，提供一对一技术支持与咨询
